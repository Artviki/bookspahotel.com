	...
	paths = {
		app: {
			...
			scripts: {
				...
				libs: [ './app/js/lib/jquery.min.js', './app/js/lib/scrolltop.js', './app/js/lib/isotope.js', './app/js/lib/select2.min.js', './app/js/lib/pikaday.min.js', './app/js/lib/handleCounter.js' ]
			},
			images: {
				root: './app/img/',
				main: './app/img/**/*',
